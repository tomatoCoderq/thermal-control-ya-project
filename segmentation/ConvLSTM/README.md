# ConvLSTM — temporal segmentation on raw IRT frames
...
```bash
python scripts/build_irt_cache.py --yaml segmentation/ConvLSTM/dataset_convlstm.yaml
```

## Train

```bash
cd segmentation/ConvLSTM
